# feature using threads and thread events rather than gpio.event
# WORKS!!!
# missing way to communicate which page is selected. Will be wored on in next version. 
##
...
class IR_reciever:
    ...
    def read_command(self, start_val):
        ...
        #if ir_keys_length['down'] == len_command: #check if the lengths are the same, all the commands are the same 
